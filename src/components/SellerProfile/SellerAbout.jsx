    ...
    return (
        <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-3 flex items-center gap-1 text-yellow-500 font-medium">
                <Star size={16} className="fill-yellow-500" /> {profile?.rating || 0}
            </p>
            <p className="font-semibold mt-1">{profile?.rate || 0}</p>
            <p className="flex items-center gap-1 mt-3 text-gray-600 dark:text-gray-300">
                <MapPin size={16} /> {profile?.location}
            </p>
            <p className="text-gray-500 mt-1">{profile?.language}</p>
