...
const Hero = () => {
  return (
    <section className="px-4">
      <div
        className={`relative main-container mt-5 rounded-2xl min-h-[80vh] h-full bg-[url(/images/hero-bg-2.jpg)] dark:bg-[url(/images/hero-bg.jpg)] bg-center bg-cover bg-no-repeat bg-blend-soft-light dark:scale-x-[-1] flex justify-center items-center text-center`}
      >
        <div class="absolute inset-0 bg-linear-to-r  from-black/60 to-black/60 rounded-2xl"></div>
        <div className="relative z-20 dark:scale-x-[-1]">
          <motion.div
          ...
          >
            ...
            >
              Find Talent.{" "}
              <span className="bg-linear-to-r from-emerald-400 to-green-600 bg-clip-text text-transparent italic drop-shadow-[0_2px_6px_rgba(16,185,129,0.4)]">
                Build Success.
              </span>
              Faster.
            </motion.h1>
